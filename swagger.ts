...
export namespace Swagger {
  ...
  export type SecuritySchemes = BasicSecurity | BasicSecurity | ApiKeySecurity | OAuth2AccessCodeSecurity | OAuth2ApplicationSecurity | OAuth2ImplicitSecurity | OAuth2PasswordSecurity | OAuth2Security3;
